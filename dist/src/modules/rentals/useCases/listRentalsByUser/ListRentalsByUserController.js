...
class ListRentalsByUserController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const listRentalsUseCase = tsyringe_1.container.resolve(ListRentalsByUserUseCase_1.ListRentalsByUserUseCase);
            const rentals = yield listRentalsUseCase.execute(user_id);
