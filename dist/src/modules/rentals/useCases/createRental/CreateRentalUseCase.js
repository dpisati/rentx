...
let CreateRentalUseCase = class CreateRentalUseCase {
    ...
    execute({ user_id, car_id, expected_return, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (rentalOpenToUser) {
                throw new AppError_1.AppError("There is a rental in progress for this user");
            }
            const dateNow = this.dateProvider.dateNow();
            const compare = this.dateProvider.compareInHours(dateNow, expected_return);
            if (compare < minimumRentHours) {
                throw new AppError_1.AppError("Rental has to be more than 24 hours");
            }
